...
For Coursera - Getting and Cleaning Data week 4 course project
...
## Actions taken before running script

1. Download the zip file
2. Unzip the zip file
3. Ensure that the folder with all the data is in your default work directory
4. Run the R script (run_analysis.R)

## Output

You will get the output as a tidy data set, Tidy.txt
